...
arquivo="VV_301_071_ETV_NEWS39_250310_final"
...
ls /home/tv/${rede}/sql/ | grep -v '^000' | grep -v 'AAProgramacao' | grep -v 'AA_Teste' | grep -v 'AAVitrineVirtual' | grep -v 'A_SKY' | while read loja
do
...
total=`ls /home/tv/${rede}/sql/ | grep -v '^000' | grep -v 'AAProgramacao' | grep -v 'AA_Teste' | grep -v 'AAVitrineVirtual' | grep -v 'A_SKY' | wc -l`
