...
path_relatorio="/ti/scripts/saluscripts/relatorios_radio/relatorios_campeao"
...
ls ${path_sistema}/${rede}/sql/ | grep Lj | while read loja
do
...
total=`ls ${path_sistema}/${rede}/sql/ | grep Lj | wc -l`
