...
path_relatorio="/ti/scripts/saluscripts/relatorios_radio/relatorios_giga"
...
ls ${path_sistema}/${rede}/sql/ | grep Casa_Verde | while read loja
do
...
total=`ls ${path_sistema}/${rede}/sql/ | grep Casa_Verde | wc -l`
